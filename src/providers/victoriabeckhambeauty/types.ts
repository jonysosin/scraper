import { TShopifyExtraData } from "providers/shopify/scraper";
...
export interface IVictoriaBeckhamBeautyAggregatedCustomVariant extends IVictoriaBeckhamBeautyCustomVariant {
  url: string
}

export type TVictoriaBeckhamBeautyExtraData = TShopifyExtraData & { variants?: Record<string, IVictoriaBeckhamBeautyAggregatedCustomVariant> }